...
export default function DashProfile() {
  ...
  return (
    <div className='max-w-lg mx-auto p-3 w-full pt-20'>
            ...
            <Modal.Header/>
                <Modal.Body>
                    <div className='text-center'>
                        ...
                        <h3 className='mb-5 text-lh text-gray-500 dark:text-gray-400'>Are you sure you want to delete your account</h3>
